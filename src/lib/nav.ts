import {
  ...
  RefreshCw, BarChart2, Settings, ShieldCheck, UserPlus, Zap, Briefcase, Kanban, Bot, Workflow, ClipboardList, Target, Megaphone,
} from "lucide-react";
...
export const NAV: NavItem[] = [
  ...
  { href: "/settings/campaigns", label: "Campaigns",               icon: Megaphone,       release: 14.4, roles: ["tenant_admin"] },
  { href: "/settings/tenant",    label: "Settings",                icon: Settings,        release: 2 },
];

export const CURRENT_RELEASE = 14.4;
