...
- **Production is now running `tradeshow-agent:8287357`** (2026-08-22, on top of `5f230b9`). Previous container preserved as `tradeshow-agent-prev-5f230b9` for instant rollback.
